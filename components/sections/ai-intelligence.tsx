      ...
      <div className="relative mx-auto max-w-6xl px-4 sm:px-6">
        <div className="grid items-center gap-12 lg:grid-cols-2">
                ...
                <StaggerItem key={item.title}>
                  <HoverLift>
                    <div className="panel-glass-dark h-full rounded-2xl p-4">
                      ...
                      <p className="mt-1.5 text-xs leading-relaxed text-navy-foreground/60">
                        {item.description}
                      </p>
                    </div>
                  </HoverLift>
          ...
          <Reveal delay={0.1} className="space-y-5">
            <div className="overflow-hidden rounded-2xl border border-primary/25 shadow-[0_28px_60px_-36px_rgb(0_0_0_/_0.7)]">
              <Image
